...
public class InvalidFileCheckerTests : TestBase
{
    ...
    private StreamWriter CreateFile(string assemblyInfo) => File.CreateText(PathHelper.Combine(this.projectDirectory, assemblyInfo));

    [Test]
    public void VerifyIgnoreNonAssemblyInfoFile()
    {
        using (var writer = CreateFile("SomeOtherFile.cs"))
        {
            writer.Write(
                """
                using System;
    ...
    {
        using (var writer = CreateFile("AssemblyInfo.cs"))
        {
            writer.Write(
                """
                using System;
    ...
    {
        using (var writer = CreateFile("AssemblyInfo.vb"))
        {
            writer.Write(
                """
                Imports System
